...
### Neon glow — .neon + severity variant

Opt-in glow modifier. Combine `.neon` with one of the six severity variants for a "lit panel" halo off the matching `--color-X-glow` token — the same convention as `.wui-btn`/`.wui-fab` `.neon-outline`, sized up for a card-sized surface. Has no effect on its own; always pair it with a color variant.

```html
<!-- Primary -->
<div class="wui-plane neon primary" style="width:100%">
  <div style="font-weight:600;margin-bottom:var(--space-1)">.neon.primary</div>
  <div style="font-size:var(--text-sm);color:var(--color-text-secondary)">Blue glow — active operational focus.</div>
</div>
<!-- Success -->
<div class="wui-plane neon success" style="width:100%">
  <div style="font-weight:600;margin-bottom:var(--space-1)">.neon.success</div>
  <div style="font-size:var(--text-sm);color:var(--color-text-secondary)">Green glow — resolved, all-clear states.</div>
</div>
<!-- Warning -->
<div class="wui-plane neon warning" style="width:100%">
  <div style="font-weight:600;margin-bottom:var(--space-1)">.neon.warning</div>
  <div style="font-size:var(--text-sm);color:var(--color-text-secondary)">Amber glow — advisories, watch conditions.</div>
</div>
<!-- Danger -->
<div class="wui-plane neon danger" style="width:100%">
  <div style="font-weight:600;margin-bottom:var(--space-1)">.neon.danger</div>
  <div style="font-size:var(--text-sm);color:var(--color-text-secondary)">Red glow — critical alerts, active hazards.</div>
</div>
<!-- Info -->
<div class="wui-plane neon info" style="width:100%">
  <div style="font-weight:600;margin-bottom:var(--space-1)">.neon.info</div>
  <div style="font-size:var(--text-sm);color:var(--color-text-secondary)">Cyan glow — informational callouts.</div>
</div>
<!-- Secondary -->
<div class="wui-plane neon secondary" style="width:100%">
  <div style="font-weight:600;margin-bottom:var(--space-1)">.neon.secondary</div>
  <div style="font-size:var(--text-sm);color:var(--color-text-secondary)">Slate glow — muted, supplementary content.</div>
</div>
```
