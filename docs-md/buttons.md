...
```js
var n = 0;
var out = document.getElementById('demo-count');
document.getElementById('demo-count-btn').addEventListener('click', function () {
  out.textContent = ++n;
});
document.getElementById('demo-count-reset').addEventListener('click', function () {
  n = 0; out.textContent = '0';
});
```
